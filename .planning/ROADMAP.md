...
- [ ] **Phase 6: Shared Types & Interaction Server Route** - New shared types and POST /api/interactions route with mock path
...
| 6. Shared Types & Interaction Server Route | v1.1 | 0/? | Not started | - |
