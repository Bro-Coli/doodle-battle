...
export function Toolbar({
  ...
  return (
    <div
      ...
      className="fixed top-4 left-1/2 z-10 flex max-w-none -translate-x-1/2 flex-wrap items-center justify-center gap-3 rounded-lg border border-neutral-300 bg-white/85 px-4 py-2 shadow-[0_2px_8px_rgba(0,0,0,0.12)] backdrop-blur-sm md:max-w-[calc(100vw-24px)] md:gap-2 md:px-3"
    >
      <ActionButtons
        canSubmit={canSubmit}
        canUndo={canUndo}
